...
class DeveloperPreview{
  ...
  private  init() {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.5Bn",percentageChange: 25.3)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$12.5Bn",percentageChange: 25.3)
